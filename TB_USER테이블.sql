...
INSERT INTO TB_USER (USER_NO, USER_ID, ISER_PW, USER_NAME, ENROLL_DATE)
SELECT (SEQ_USER_NO.NEXTVAL, 'user06', 'pass06', '유저육', DEFAULT)
WHERE NOT EXISTS (SELECT USER_NAME FROM TB_USER WHERE USER_NAME = '장미애');
